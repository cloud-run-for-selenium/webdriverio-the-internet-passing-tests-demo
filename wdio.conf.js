...
exports.config = {
    ...
    services: ['chromedriver'], // ['eslinter', { runnerType: 'yarn' }]],
    //services: ['chromedriver', 'eslinter', [AllureEnvironment]],
    ...
    //                 "wdio.*",
    //                 "_wdio.*",
    //                 "add-logger-to-files.js",
    //                 "test-async/**",
    //                 "async-allure-report/**",
    //                 "start-selenium-docker.js",
    //                 "allure-report/**",
    //                 "test-sync/pageobjects/**",
    //                 "test-sync/specs/e*"
    //             ]
    //         }
    //     }
    ...
    onPrepare: function (config, capabilities) {
        ...
        (async () => {
            ...
            logger.log('Deleted files and directories:\n', deletedPaths.join('\n'));
        })();
    },
    /**

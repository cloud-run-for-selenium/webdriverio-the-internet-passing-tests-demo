// wdio.edge-cloud-container-service.conf.js

/*
 This configuration runs in Google Cloud Run, and headfully, meaning not headless.

 From the WebdriverIO docs:
 $ CLOUD_CONTAINER_APP_URL=<your_cloud_container_url> CLOUD_CONTAINER_ACCESS_TOKEN=<token> npx wdio wdio.edge-cloud-container-service.conf.js
